...
Implementation of Apriori Algorithm with extended prefix tree optimization similar to as given in Zaki's Book
"""
...
def main(dataset_path):
    ...
    minSup = 0.22222 # enter this in terms of ratio
    # minSup = float(input())
    min_support_cnt = float(minSup*N)   
